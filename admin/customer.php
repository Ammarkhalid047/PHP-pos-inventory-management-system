...
<div class="container-fluid">
	<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Employers
				<span class="pull-right">
					<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addcustomer"><i class="fa fa-plus-circle"></i> Add Employer</button>
				</span>
			</h1>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <table width="100%" class="table table-striped table-bordered table-hover" id="cusTable">
				...
				<?php
					...
					?>
							<td><a href="sell.php?id=<?php echo $cqrow["userid"]?>"><?php echo $cqrow['customer_name']; ?></a></td>
							<td>
