<!-- Navigation -->
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <a class="navbar-brand" href=""> SURVICO SURGICAL</a>
            </div>
			...
			<ul class=" nav navbar-nav">
                ...
                <!--<li id="cartme" style="cursor:pointer">
                   <a href="../admin/backup.php"><i class="fa fa-shopping-cart fa-fw"></i>Backup</a>
                </li>-->
				<li id="history"><a href="#"><span class="fa fa-list-alt"></span> PURCHASE</a></li>
				<li>
